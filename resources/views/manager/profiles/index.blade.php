...
@section('content')
    <div class="container page-profile mb-4">
        <div class="row">
            <div class="col-md-6">
                ...
                @endif
                <form action="{{ route('tourist-update-profile', $user->id) }}" method="post" class="form-profile"
            ...
            <div class="col-md-6">
                ...
                @endif
                <form action="{{ route('change-password') }}" method="post" class="change-password">
                    @csrf
                    <div class="form-group">
